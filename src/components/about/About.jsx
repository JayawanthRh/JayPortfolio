    ...
    <section className="about section" id="about">
      ...
      <div className="about__container container grid">
        ...
        <div className="about__data">
          ...
          I'm Jayawanth Rayak, a passionate Full-Stack & AI Engineer, with a strong foundation in full-stack development and a keen interest in Artificial intelligence. My journey in technology has been driven by a desire to build scalable, data-driven applications that not only solve complex problems but also deliver meaningful value to users.
